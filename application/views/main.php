...
<div class="page-body mt-2">
    ...
    <div class="row row-deck row-cards">
        <div class="col-sm-12 col-lg-6">
            <!-- <div class="row bg-pink w-100"> -->
                <div class="col-sm-12 col-lg-12">
                    <div class="card">
                        <div class="card-body d-flex">
                            <div class="">
                                <div class="d-flex align-items-center">
                                    <div class="page-title">Selamat datang kembali, <?= strtoupper(datauser($this->session->userdata('id'),'username')) ?> !</div>
                                </div>
                                <div class="mb-2 mt-4">Anda mempunyai <span class="text-danger">200</span> task yang perlu anda validasi, link validasi ada pada menu dikanan atas pada avatar anda.</div>
                            ...
                            <div class="p-5">
                                <img src="<?= base_url().'assets/img/' ?>assets/undraw_build-mode_aa78.svg" style="width:200px;" alt="gambar latar">
                            </div>
                        </div>
                    </div>
                </div>
