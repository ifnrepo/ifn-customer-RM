        ...
        <div class="card-body p-1">
            ...
            <div id="addjaring" class="hilang">
                <div class="row mt-1">
                    ...
                    <div class="col">
                        <select id="knot-tipe" name="knot-tipe" class="form-select form-control font-kecil">
                            ...
                            <option value="S">S/K</option>
                            <option value="W">W/K</option>
                            <option value="X">X/K</option>
                            <option value="Y">Y/K</option>
                            <option value="Z">Z/K</option>
                        </select>
                    </div>
                </div>
                <div class="row mt-1">
                    ...
                    <div class="col">
                        <select id="jenis-benang" name="jenis-benang" class="form-select form-control font-kecil">
                            ...
                            <?php foreach($jns_benang->result_array() as $jnb): ?>
                                <option value="<?= $jnb['jnb'] ?>"><?= $jnb['jnb'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col">
                ...
                <div class="row mt-1">
                    ...
                    <div class="col">
                        <input type="text" name="meai" id="meai" class="form-control font-kecil text-end">
                    </div>
                    <div class="col">
                        <select id="sat-meai" name="sat-meai" class="form-select form-control font-kecil">
                            <option value="">-- Satuan Meai --</option>
                            <option value="S">MMSTR</option>
                            <option value="Q">MMSQ</option>
                ...
                <div class="row mt-1">
                    ...
                    <div class="col">
                        <input type="text" name="md" id="md" class="form-control font-kecil inputangka text-end">
                    </div>
                    <div class="col">
                ...
                <div class="row mt-1">
                    ...
                    <div class="col">
                        <input type="text" name="length" id="length" class="form-control font-kecil inputangka text-end">
                    </div>
                    <div class="col">
                ...
                <div class="row mt-1">
                    ...
                    <div class="col">
                        <select id="color" name="color" class="form-select font-kecil">
                            ...
                            <?php foreach($getcolor->result_array() as $clr): ?>
                ...
                <div class="row mt-1">
                    ...
                    <div class="col">
                        <input type="text" name="keterangan" id="keterangan" class="form-control font-kecil">
                    </div>
                </div>
                <hr class="m-0">
            ...
            <div id="addother" class="hilang">
                <div class="row mt-1">
                    ...
                    <div class="col">
                        <input type="text" name="prod-oth" id="prod-oth" class="form-control font-kecil" readonly>
                    </div>
                </div>
                <div class="row mt-1">
                    <label class="col-3 col-form-label">Ukuran</label>
                    <div class="col">
                        <input type="text" name="ukuran-oth" id="ukuran-oth" class="form-control font-kecil">
                    </div>
                </div>
                <div class="row mt-1">
                    <label class="col-3 col-form-label">Tipe</label>
                    <div class="col line-11">
                        <input type="text" name="tipe-oth" id="tipe-oth" class="form-control font-kecil mb-0">
                ...
                <div class="row mt-1">
                    ...
                    <div class="col line-11">
                        <input type="text" name="package-oth" id="package-oth" class="form-control font-kecil mb-0">
                        <!-- <small class="form-hint mt-0">We'll never share your email with anyone else.</small> -->
                    </div>
                </div>
                <div class="row mt-1">
                ...
                <div class="row mt-1">
                    <label class="col-3 col-form-label">Keterangan</label>
                    <div class="col line-11">
                        <input type="text" name="keterangan-oth" id="keterangan-oth" class="form-control font-kecil mb-0">
                        <!-- <small class="form-hint mt-0">We'll never share your email with anyone else.</small> -->
                    </div>
                </div>
                <!-- <div class="row mt-1">
