        ...
        <div class="card-body p-1">
            <div id="addjaring" class="">
                <div class="row mt-1">
                    ...
                    <div class="col">
                        <div class="input-group mb-1">
                            <input type="text" class="form-control font-kecil" id="textcariproduk" placeholder="Cari data.." value="">
                            <button class="btn btn-success font-kecil hilang" id="btncariproduk" type="button">Cari !</button>
                            <button class="btn btn-danger font-kecil hilang" id="btnhapusproduk" type="button">Hapus !</button>
                        </div>
                        <small class="form-hint mt-0 text-azure ms-1" id="kodeproduk"></small>
                        <input type="text" class="hilang" name="idproduk" id="idproduk">
                    </div>
                </div>
                ...
                <div class="row my-1">
                    ...
                    <div class="col">
                        <textarea name="keterangan" id="keterangan" class="form-control font-kecil"></textarea>
                    </div>
                </div>
                <hr class="m-0">
                <div class="text-center mt-1">
                    <a href="#" class="btn btn-sm btn-success font-kecil" id="simpanhikiaidetail"><span class="text-black">Simpan</span></a>
...
<script>
    ...
    $("#simpanhikiaidetail").click(function(){
        if($("#idproduk").val()==''){
        ...
        $.ajax({
            dataType: "json",
            type: "POST",
            url: base_url + "hikiai/simpandetailhikiai",
            data: {
                idhik : $("#idhik").val(),
                idprod: $("#idproduk").val(),
                pcs: $("#pcs").val(),
